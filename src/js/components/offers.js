...
class Offers extends Component {
  _data;
  _parentEl = document.querySelector('.offers-content');
  ...
  _generateMarkup(product) {
    return `<div class="card-wrapper reveal" data-id="${product.id}">
              <div
                class="card text-center rounded-5 card-face card-face--front"
              >
                <img
                  src="${image}"
                  alt="${product.imgAlt}"
              ...
              <div class="card text-center rounded-5 card-face card-face--back">
                <img
                  src="${image}"
                  alt="${product.imgAlt}"
                  class="card-image-top card-image-top--back rounded-top-5"
